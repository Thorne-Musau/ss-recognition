...
automatic_path = 'Gunshots (1)/Gunshots/Automatic'  # Copy relative paths
single_shot_path = 'Gunshots (1)/Gunshots/Single Shot' # Copy relative paths
ambience_path = '1_Ambience Sound/Ambience Sound' # Copy relative paths
